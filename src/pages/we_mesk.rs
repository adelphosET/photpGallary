...
// Replace asset! paths with your actual asset! macro calls if needed.
const IMAGES: &[ImageItem] = &[
     ImageItem {
         thumb: asset!("/assets/data/mesk/CV6A1174.avif"),
         full: asset!("/assets/data/mesk/CV6A1174.avif"),
         alt: "CV6A1174",
     },
     ImageItem {
         thumb: asset!("/assets/data/mesk/CV6A1178.avif"),
         full: asset!("/assets/data/mesk/CV6A1178.avif"),
         alt: "CV6A1178",
     },
     ImageItem {
         thumb: asset!("/assets/data/mesk/CV6A1187.avif"),
         full: asset!("/assets/data/mesk/CV6A1187.avif"),
         alt: "CV6A1187",
     },
     ImageItem {
         thumb: asset!("/assets/data/mesk/CV6A1195 copy.avif"),
         full: asset!("/assets/data/mesk/CV6A1195 copy.avif"),
         alt: "CV6A1195 copy",
     },
];
