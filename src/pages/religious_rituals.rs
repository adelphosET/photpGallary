...
const IMAGES: &[ImageItem] = &[
        ...
        ImageItem {
            thumb: asset!("/assets/data/rituals/7S8A2006.webp"),
            full: asset!("/assets/data/rituals/7S8A2006.webp"),
            alt: "7S8A2006",
        },
        ImageItem {
            thumb: asset!("/assets/data/rituals/7S8A2010.webp"),
            full: asset!("/assets/data/rituals/7S8A2010.webp"),
            alt: "7S8A2010",
        },
        ImageItem {
            thumb: asset!("/assets/data/rituals/7S8A2014.webp"),
            full: asset!("/assets/data/rituals/7S8A2014.webp"),
            alt: "7S8A2014",
        },
];
#[component]
pub fn ReligiousRituals()  -> Element {
